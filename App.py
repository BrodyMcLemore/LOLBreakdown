...
def Run():
    ...
    if SaveBook(wb,AccountName) == "Success":
        messagebox.showinfo("Success", "Your Game Data has been saved to a new folder named 'Output'.")
    elif SaveBook(wb,AccountName) == "Fail":
        messagebox.showerror("Failure", "Your Game Data did NOT save correctly, please try again")
...
RegionComboBox = ttk.Combobox(MainFrame,textvariable=RegionVal,values=RegionCommon,state="readonly",font=('calibre',10,'normal'))
